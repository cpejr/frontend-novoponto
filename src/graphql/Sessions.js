...
const PRESENTIAL_MEMBERS = gql`
  query PresentialMembers {
  presentialMembers {
    name
  }
}
`;
export { LOGGED_MEMBERS, CREATE_SESSION, FINISH_SESSION, END_ALL_SESSIONS, DELETE_SESSION, UPDATE_SESSION,PRESENTIAL_MEMBERS };
