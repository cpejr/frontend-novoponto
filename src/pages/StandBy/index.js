...
const StandBy = () => {
	...
	useEffect(() => {
		function carregou() {
			...
			// css.type = "text/css";
			css.innerHTML = `.txt-rotate > .wrap { height: 100px; border-right: 0.18em solid ${changeableColors.appPrimaryColor}; border-radius: 5px 5px 5px 5px; }`;
	...
	return (
		<StandByComponent theme={themeColors}>
			...
			<a className="linkGoBack" onClick={goBack}>
